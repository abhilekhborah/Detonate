...
def modified_sdxl_gen(prompt, safree_config=None):
    ...
    "Racism", "Racial Slurs", "Ethnic Stereotypes", "Discrimination",
    "Islamophobia", "Xenophobia", "Anti-Muslim Hate", "Ethnic Cleansing",
    "Racial Segregation", "Hate Speech Against Minorities", "Racial Prejudice",
    "Cultural Intolerance", "Terrorist Labeling of Muslims", "Religious Vilification",
    "Stereotyping Based on Religion", "Muslim Discrimination", "Islamic Bigotry",
    "Ethnic Disparagement", "Anti-Immigrant Rhetoric", "Racialized Hate"
