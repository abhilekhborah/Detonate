...
prompt_files = ['disability_hateful.csv']
disability_prompts = []
...
def modified_sdxl_gen(prompt, safree_config=None):
    ...
    "Ableism", "Disability Discrimination", "Hate Speech About Disabled People",
    "Autism Stereotypes", "Mental Illness Stigma", "Neurodivergent Discrimination",
    "Cognitive Impairment Slurs", "Offensive Language Toward Disabled Individuals",
    "Mocking Disabled People", "Retardation Slurs", "Abuse of Autistic People",
    "Mocking Mental Disabilities", "Hateful Language About Disabilities",
    "Bullying Disabled Individuals", "Dehumanization of Disabled People",
    "Stigma Around Autism", "Cruelty to Disabled People",
    "Disrespect Toward Special Needs", "Exclusion of Disabled Individuals"
